...
from trade.broker.trader import Trader, get_position
from trade.logger import LOG_FILE_PATH, trading_logger
...
def create_lark_handler(trader: Trader):
  ...
  def handle_action_query_positions():
    ...
    from trade.broker.helper import get_stock_desc
